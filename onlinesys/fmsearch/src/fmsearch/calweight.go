...
func (this *StySearcher) queryMatch(styData *strategyData, inId InIdType, termInQuery []TermInQuery,
	...
	termInDocFeature := make([]sty.TermInDocFeature, len(termInDoc), len(termInDoc))
...
// doc的命中情况
func (this *StySearcher) docMatch(styData *strategyData, inId InIdType,
	termInQuery []TermInQuery, termInDoc []TermInDoc) float32 {

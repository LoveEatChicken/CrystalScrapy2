...
def format_with_separator(iterate,separator=',',is_values = False):
    '''
    用分隔符格式化
    :param iterate:
    :param separator:
    ...
    for i,v in enumerate(iterate):
        if is_values and isinstance(v, (str, unicode)):
            v = "'" + v + "'"
